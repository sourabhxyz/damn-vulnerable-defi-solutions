...
describe('[Challenge] The rewarder', function () {
  ...
  before(async function () {
    ...
    this.rewardToken = RewardTokenFactory.attach(
      await this.rewarderPool.rewardToken()
    );
    this.accountingToken = AccountingTokenFactory.attach(
  ...
  it('Exploit', async function () {
    ...
    const AttackContractFactory = await ethers.getContractFactory(
      'AttackTheRewarderPool',
      attacker
    );
    this.attackContract = await AttackContractFactory.deploy(
