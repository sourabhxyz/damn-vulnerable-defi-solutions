...
describe('[Challenge] Side entrance', function () {
  ...
  it('Exploit', async function () {
    ...
    const AttackerSideEntranceFactory = await ethers.getContractFactory(
      'AttackSideEntranceLenderPool',
      attacker
    );
    const attackerContract = await AttackerSideEntranceFactory.deploy(
      this.pool.address
    );
